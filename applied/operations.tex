...
\begin{enumerate}
    \item serialize k :: \{1, T[k]\} $\rightarrow$ \{k, T\}
    \item deserialize k :: \{k, T\} $\rightarrow$ \{1, T[k]\}
\end{enumerate}
...
\begin{enumerate}
    \item map\_seq p f :: [$S_1$[p], $\emptyset$(1:n-1)] $\rightarrow$ ... 
        $\rightarrow$ [$S_{n-1}$[p], $\emptyset$(1:n-1)] $\rightarrow$ 
        [$\emptyset$(0:n-2), T[p]]
        \subitem s.t. f :: $S_1 \rightarrow$ ... $\rightarrow S_n \rightarrow$ T 
    \item reduce p f :: T[p] $\rightarrow$ T
        \subitem s.t. f :: (T,T)$\rightarrow$ T
