...
magmaInstance0 = DefineTwoDimensionalLineBuffer(cirb, Array(8, In(Bit)), 2, 1, 2, 2, 8, 8, 1, 1, 0, 0)()
...
wire(magmaInstance6.O, magmaInstance14.I1)
wire(magmaInstance0.O[0][1][0], magmaInstance15.I0)
wire(magmaInstance3.O, magmaInstance15.I1)
...
wire(magmaInstance7.O, magmaInstance18.I1)
wire(magmaInstance0.O[1][1][0], magmaInstance19.I0)
wire(magmaInstance4.O, magmaInstance19.I1)
