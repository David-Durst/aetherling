...
partialParallel8Convolution = DefineCircuit('partialParallel8Convolution_Circuit', *args)
magmaInstance0 = DefineTwoDimensionalLineBuffer(cirb, Array(8, In(Bit)), 8, 1, 2, 2, 8, 8, 1, 1, 0, 0)()
...
wire(magmaInstance24.O, magmaInstance62.I1)
wire(magmaInstance0.O[0][1][0], magmaInstance63.I0)
wire(magmaInstance9.O, magmaInstance63.I1)
...
wire(magmaInstance25.O, magmaInstance66.I1)
wire(magmaInstance0.O[1][1][0], magmaInstance67.I0)
wire(magmaInstance10.O, magmaInstance67.I1)
...
wire(magmaInstance26.O, magmaInstance70.I1)
wire(magmaInstance0.O[2][1][0], magmaInstance71.I0)
wire(magmaInstance11.O, magmaInstance71.I1)
...
wire(magmaInstance27.O, magmaInstance74.I1)
wire(magmaInstance0.O[3][1][0], magmaInstance75.I0)
wire(magmaInstance12.O, magmaInstance75.I1)
...
wire(magmaInstance28.O, magmaInstance78.I1)
wire(magmaInstance0.O[4][1][0], magmaInstance79.I0)
wire(magmaInstance13.O, magmaInstance79.I1)
...
wire(magmaInstance29.O, magmaInstance82.I1)
wire(magmaInstance0.O[5][1][0], magmaInstance83.I0)
wire(magmaInstance14.O, magmaInstance83.I1)
...
wire(magmaInstance30.O, magmaInstance86.I1)
wire(magmaInstance0.O[6][1][0], magmaInstance87.I0)
wire(magmaInstance15.O, magmaInstance87.I1)
...
wire(magmaInstance31.O, magmaInstance90.I1)
wire(magmaInstance0.O[7][1][0], magmaInstance91.I0)
wire(magmaInstance16.O, magmaInstance91.I1)
...
wire(partialParallel8Convolution.I0, magmaInstance0.I[0][0])
wire(partialParallel8Convolution.I1, magmaInstance0.I[0][1])
wire(partialParallel8Convolution.I2, magmaInstance0.I[0][2])
wire(partialParallel8Convolution.I3, magmaInstance0.I[0][3])
wire(partialParallel8Convolution.I4, magmaInstance0.I[0][4])
wire(partialParallel8Convolution.I5, magmaInstance0.I[0][5])
wire(partialParallel8Convolution.I6, magmaInstance0.I[0][6])
wire(partialParallel8Convolution.I7, magmaInstance0.I[0][7])
wire(partialParallel8Convolution.O0, magmaInstance93.out)
wire(partialParallel8Convolution.O1, magmaInstance94.out)
wire(partialParallel8Convolution.O2, magmaInstance95.out)
wire(partialParallel8Convolution.O3, magmaInstance96.out)
wire(partialParallel8Convolution.O4, magmaInstance97.out)
