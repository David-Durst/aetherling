...
wire(sequentialConvolution.ready_data_in, sequentialConvolution.ready_data_out)
wire(sequentialConvolution.valid_data_in & bit(sequentialConvolution.CE), magmaInstance0.CE)
