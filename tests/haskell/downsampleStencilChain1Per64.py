...
args = ['lb0Valid', Out(Bit), 'lb0Ready', Out(Bit), 'lb0CE', Out(Bit), 'lb0Out', Out(Array(1, Array(2, Array(2, Array(8, Bit))))), 'lb1In', Out(Array(1, Array(1, Array(8, Bit)))), 'lb1Valid', Out(Bit), 'lb1Ready', Out(Bit), 'lb1CE', Out(Bit),'lb1Out', Out(Array(1, Array(2, Array(2, Array(8, Bit))))), 'lb2In', Out(Array(1, Array(1, Array(8, Bit)))),  'lb2Valid', Out(Bit), 'lb2Ready', Out(Bit), 'lb2CE', Out(Bit), 'I0', Array(8, In(Bit)), 'O0', Array(8, Out(Bit)), 'valid_data_in', In(Bit), 'ready_data_in', Out(Bit), 'valid_data_out', Out(Bit), 'ready_data_out', In(Bit), ] + ClockInterface(has_ce=True)
downsampleStencilChain1Per64 = DefineCircuit('downsampleStencilChain1Per64_Circuit', *args)
magmaInstance0 = DefineTwoDimensionalLineBuffer(cirb, Array(8, In(Bit)), 1, 1, 2, 2, 16, 16, 2, 2, 0, 0)()
magmaInstance1 = DefineNoop(DefineTwoDimensionalLineBuffer(cirb, Array(8, In(Bit)), 1, 1, 2, 2, 16, 16, 2, 2, 0, 0))()
...
magmaInstance14 = DefineTwoDimensionalLineBuffer(cirb, Array(8, In(Bit)), 1, 1, 2, 2, 8, 8, 2, 2, 0, 0)()
wire(magmaInstance13.O, magmaInstance14.I[0][0])
magmaInstance15 = DefineNoop(DefineTwoDimensionalLineBuffer(cirb, Array(8, In(Bit)), 1, 1, 2, 2, 8, 8, 2, 2, 0, 0))()
...
magmaInstance28 = DefineTwoDimensionalLineBuffer(cirb, Array(8, In(Bit)), 1, 1, 2, 2, 4, 4, 2, 2, 0, 0)()
wire(magmaInstance27.O, magmaInstance28.I[0][0])
magmaInstance29 = DefineNoop(DefineTwoDimensionalLineBuffer(cirb, Array(8, In(Bit)), 1, 1, 2, 2, 4, 4, 2, 2, 0, 0))()
...
wire(downsampleStencilChain1Per64.I0, magmaInstance0.I[0][0])
wire(downsampleStencilChain1Per64.O0, magmaInstance41.O)
wire(magmaInstance0.ready, downsampleStencilChain1Per64.ready_data_in)
wire(magmaInstance28.valid, downsampleStencilChain1Per64.valid_data_out)
wire(downsampleStencilChain1Per64.valid_data_in & magmaInstance14.ready & bit(downsampleStencilChain1Per64.CE), magmaInstance0.CE)
wire(magmaInstance0.valid & magmaInstance28.ready & bit(downsampleStencilChain1Per64.CE), magmaInstance14.CE)
wire(magmaInstance14.valid & downsampleStencilChain1Per64.ready_data_out & bit(downsampleStencilChain1Per64.CE), magmaInstance28.CE)

wire(magmaInstance0.valid, downsampleStencilChain1Per64.lb0Valid)
wire(magmaInstance0.ready, downsampleStencilChain1Per64.lb0Ready)
wire(downsampleStencilChain1Per64.valid_data_in & magmaInstance14.ready & bit(downsampleStencilChain1Per64.CE), downsampleStencilChain1Per64.lb0CE)
wire(magmaInstance14.valid, downsampleStencilChain1Per64.lb1Valid)
wire(magmaInstance14.ready, downsampleStencilChain1Per64.lb1Ready)
wire(magmaInstance0.valid & magmaInstance28.ready & bit(downsampleStencilChain1Per64.CE), downsampleStencilChain1Per64.lb1CE)
wire(magmaInstance28.valid, downsampleStencilChain1Per64.lb2Valid)
wire(magmaInstance28.ready, downsampleStencilChain1Per64.lb2Ready)
wire(magmaInstance14.valid & downsampleStencilChain1Per64.ready_data_out & bit(downsampleStencilChain1Per64.CE), downsampleStencilChain1Per64.lb2CE)
wire(magmaInstance0.O, downsampleStencilChain1Per64.lb0Out)
wire(magmaInstance13.O, downsampleStencilChain1Per64.lb1In[0][0])
wire(magmaInstance14.O, downsampleStencilChain1Per64.lb1Out)
wire(magmaInstance27.O, downsampleStencilChain1Per64.lb2In[0][0])

ceTerm = TermAnyType(cirb, Enable)
wire(ceTerm.I, downsampleStencilChain1Per64.CE)
EndCircuit()
