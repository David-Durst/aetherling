...
magmaInstance0 = DefineTwoDimensionalLineBuffer(cirb, Array(8, In(Bit)), 4, 1, 2, 2, 8, 8, 1, 1, 0, 0)()
...
wire(magmaInstance12.O, magmaInstance30.I1)
wire(magmaInstance0.O[0][1][0], magmaInstance31.I0)
wire(magmaInstance5.O, magmaInstance31.I1)
...
wire(magmaInstance13.O, magmaInstance34.I1)
wire(magmaInstance0.O[1][1][0], magmaInstance35.I0)
wire(magmaInstance6.O, magmaInstance35.I1)
...
wire(magmaInstance14.O, magmaInstance38.I1)
wire(magmaInstance0.O[2][1][0], magmaInstance39.I0)
wire(magmaInstance7.O, magmaInstance39.I1)
...
wire(magmaInstance15.O, magmaInstance42.I1)
wire(magmaInstance0.O[3][1][0], magmaInstance43.I0)
wire(magmaInstance8.O, magmaInstance43.I1)
...
wire(partialParallel4Convolution.ready_data_in, partialParallel4Convolution.ready_data_out)
wire(partialParallel4Convolution.valid_data_in & bit(partialParallel4Convolution.CE), magmaInstance0.CE)
