...
magmaInstance23 = DefineReduceParallel(4, renameCircuitForReduce(DefineAdd(8)))()
...
magmaInstance41 = DefineReduceParallel(4, renameCircuitForReduce(DefineAdd(8)))()
...
magmaInstance55 = DefineReduceParallel(4, renameCircuitForReduce(DefineAdd(8)))()
