...
magmaInstance0 = DefineTwoDimensionalLineBuffer(cirb, Array[8, In(Bit)], 8, 1, 2, 2, 256, 256, 2, 2, 0, 0)()
magmaInstance1 = DefineNoop(DefineTwoDimensionalLineBuffer(cirb, Array[8, In(Bit)], 8, 1, 2, 2, 256, 256, 2, 2, 0, 0))()
...
magmaInstance23 = DefineReduceParallel(cirb, 4, renameCircuitForReduce(DefineAdd(8)))()
...
magmaInstance31 = DefineTwoDimensionalLineBuffer(cirb, Array[8, In(Bit)], 2, 1, 2, 2, 128, 128, 2, 2, 0, 0)()
wire(magmaInstance29.O, magmaInstance31.I[0][0])
wire(magmaInstance30.O, magmaInstance31.I[0][1])
magmaInstance32 = DefineNoop(DefineTwoDimensionalLineBuffer(cirb, Array[8, In(Bit)], 2, 1, 2, 2, 128, 128, 2, 2, 0, 0))()
...
magmaInstance41 = DefineReduceParallel(cirb, 4, renameCircuitForReduce(DefineAdd(8)))()
...
magmaInstance45 = DefineTwoDimensionalLineBuffer(cirb, Array[8, In(Bit)], 1, 1, 2, 2, 64, 64, 2, 2, 0, 0)()
wire(magmaInstance44.O, magmaInstance45.I[0][0])
magmaInstance46 = DefineNoop(DefineTwoDimensionalLineBuffer(cirb, Array[8, In(Bit)], 1, 1, 2, 2, 64, 64, 2, 2, 0, 0))()
...
magmaInstance55 = DefineReduceParallel(cirb, 4, renameCircuitForReduce(DefineAdd(8)))()
