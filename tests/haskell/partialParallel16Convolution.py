...
magmaInstance0 = DefineTwoDimensionalLineBuffer(Array[8, In(Bit)], 8, 2, 2, 2, 8, 8, 1, 1, 0, 0)()
...
magmaInstance189 = DefineReduceParallelWithIdentity(4, renameCircuitForReduce(DefineAdd(8)))()
