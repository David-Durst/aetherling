...
wire(partialParallel16Convolution.ready_data_in, partialParallel16Convolution.ready_data_out)
wire(partialParallel16Convolution.valid_data_in & bit(partialParallel16Convolution.CE), magmaInstance0.CE)
