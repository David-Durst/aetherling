...
args = ['I0', Array[8, In(Bit)], 'I1', Array[8, In(Bit)], 'I2', Array[8, In(Bit)], 'I3', Array[8, In(Bit)], 'O0', Array[8, Out(Bit)], 'valid_data_in', In(Bit), 'ready_data_in', Out(Bit), 'valid_data_out', Out(Bit), 'ready_data_out', In(Bit), ] + ClockInterface(has_ce=True)
downsample_256x256_to_32x32_4px_in_per_clk = DefineCircuit('downsample_256x256_to_32x32_4px_in_per_clk_Circuit', *args)
magmaInstance0 = DefineTwoDimensionalLineBuffer(Array[8, In(Bit)], 4, 1, 2, 2, 256, 256, 2, 2, 0, 0)()
magmaInstance1 = DefineNoop(DefineTwoDimensionalLineBuffer(Array[8, In(Bit)], 4, 1, 2, 2, 256, 256, 2, 2, 0, 0))()
...
wire(downsample_256x256_to_32x32_4px_in_per_clk.I0, magmaInstance0.I[0][0])
wire(downsample_256x256_to_32x32_4px_in_per_clk.I1, magmaInstance0.I[0][1])
wire(downsample_256x256_to_32x32_4px_in_per_clk.I2, magmaInstance0.I[0][2])
wire(downsample_256x256_to_32x32_4px_in_per_clk.I3, magmaInstance0.I[0][3])
wire(downsample_256x256_to_32x32_4px_in_per_clk.O0, magmaInstance41.O)
wire(magmaInstance0.ready, downsample_256x256_to_32x32_4px_in_per_clk.ready_data_in)
wire(magmaInstance28.valid, downsample_256x256_to_32x32_4px_in_per_clk.valid_data_out)
wire(downsample_256x256_to_32x32_4px_in_per_clk.valid_data_in & magmaInstance14.ready & bit(downsample_256x256_to_32x32_4px_in_per_clk.CE), magmaInstance0.CE)
wire(magmaInstance0.valid & magmaInstance28.ready & bit(downsample_256x256_to_32x32_4px_in_per_clk.CE), magmaInstance14.CE)
wire(magmaInstance14.valid & downsample_256x256_to_32x32_4px_in_per_clk.ready_data_out & bit(downsample_256x256_to_32x32_4px_in_per_clk.CE), magmaInstance28.CE)
ceTerm = TermAnyType(Enable)
wire(ceTerm.I, downsample_256x256_to_32x32_4px_in_per_clk.CE)
EndCircuit()
