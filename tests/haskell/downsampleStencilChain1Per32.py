...
stencilChain1Per32 = DefineCircuit('stencilChain1Per32_Circuit', *args)
...
wire(stencilChain1Per32.I0, magmaInstance0.I[0][0])
wire(stencilChain1Per32.I1, magmaInstance0.I[0][1])
wire(stencilChain1Per32.O0, magmaInstance41.O)
wire(magmaInstance0.ready, stencilChain1Per32.ready_data_in)
wire(magmaInstance28.valid, stencilChain1Per32.valid_data_out)
wire(stencilChain1Per32.valid_data_in & magmaInstance14.ready & bit(stencilChain1Per32.CE), magmaInstance0.CE)
wire(magmaInstance0.valid & magmaInstance28.ready & bit(stencilChain1Per32.CE), magmaInstance14.CE)
wire(magmaInstance14.valid & stencilChain1Per32.ready_data_out & bit(stencilChain1Per32.CE), magmaInstance28.CE)
ceTerm = TermAnyType(cirb, Enable)
wire(ceTerm.I, stencilChain1Per32.CE)
EndCircuit()
