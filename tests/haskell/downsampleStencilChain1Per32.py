...
magmaInstance0 = DefineTwoDimensionalLineBuffer(cirb, Array[8, In(Bit)], 2, 1, 2, 2, 16, 16, 2, 2, 0, 0)()
magmaInstance1 = DefineNoop(DefineTwoDimensionalLineBuffer(cirb, Array[8, In(Bit)], 2, 1, 2, 2, 16, 16, 2, 2, 0, 0))()
...
wire(downsampleStencilChain1Per32.I0, magmaInstance0.I[0][0])
wire(downsampleStencilChain1Per32.I1, magmaInstance0.I[0][1])
wire(downsampleStencilChain1Per32.O0, magmaInstance41.O)
wire(magmaInstance0.ready, downsampleStencilChain1Per32.ready_data_in)
wire(magmaInstance28.valid, downsampleStencilChain1Per32.valid_data_out)
wire(downsampleStencilChain1Per32.valid_data_in & magmaInstance14.ready & bit(downsampleStencilChain1Per32.CE), magmaInstance0.CE)
wire(magmaInstance0.valid & magmaInstance28.ready & bit(downsampleStencilChain1Per32.CE), magmaInstance14.CE)
wire(magmaInstance14.valid & downsampleStencilChain1Per32.ready_data_out & bit(downsampleStencilChain1Per32.CE), magmaInstance28.CE)
ceTerm = TermAnyType(cirb, Enable)
wire(ceTerm.I, downsampleStencilChain1Per32.CE)
EndCircuit()
