...
magmaInstance101 = DefineReduceParallel(4, renameCircuitForReduce(DefineAdd(8)))()
...
magmaInstance155 = DefineReduceParallel(4, renameCircuitForReduce(DefineAdd(8)))()
magmaInstance156 = DefineReduceParallel(4, renameCircuitForReduce(DefineAdd(8)))()
...
magmaInstance174 = DefineReduceParallel(4, renameCircuitForReduce(DefineAdd(8)))()
